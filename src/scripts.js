...
function calculateInvoiceValue(event) {
    ...
    const sickDailyRateFactor = divide(document.querySelector('#sick-daily-rate-factor').valueAsNumber, 100);
    const sickDaysCount = document.querySelector('#sick-days-count').valueAsNumber;
    const workDaysCount = document.querySelector('#work-days-count').valueAsNumber;
